...
#ifndef __s_compute_acoustiudo__HH__
#define __s_compute_acoustiudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustiudo) {
    ...
    SC_CTOR(s_compute_acoustiudo):  ACMP_srem_seq_U ("ACMP_srem_seq_U") {
