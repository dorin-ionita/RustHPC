...
#ifndef __s_compute_acoustilbW__HH__
#define __s_compute_acoustilbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustilbW) {
    ...
    SC_CTOR(s_compute_acoustilbW):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
