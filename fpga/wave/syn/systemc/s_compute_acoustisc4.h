...
#ifndef __s_compute_acoustisc4__HH__
#define __s_compute_acoustisc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustisc4) {
    ...
    SC_CTOR(s_compute_acoustisc4):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
