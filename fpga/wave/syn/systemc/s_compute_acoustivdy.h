...
#ifndef __s_compute_acoustivdy__HH__
#define __s_compute_acoustivdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustivdy) {
    ...
    SC_CTOR(s_compute_acoustivdy):  ACMP_smul_us_U ("ACMP_smul_us_U") {
