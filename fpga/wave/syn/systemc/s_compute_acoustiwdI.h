...
#ifndef __s_compute_acoustiwdI__HH__
#define __s_compute_acoustiwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustiwdI) {
    ...
    SC_CTOR(s_compute_acoustiwdI):  simcore_mac_0_U ("simcore_mac_0_U") {
