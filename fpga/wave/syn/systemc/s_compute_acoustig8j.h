...
#ifndef __s_compute_acoustig8j__HH__
#define __s_compute_acoustig8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustig8j) {
    ...
    SC_CTOR(s_compute_acoustig8j):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
