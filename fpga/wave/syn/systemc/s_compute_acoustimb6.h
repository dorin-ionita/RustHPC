...
#ifndef __s_compute_acoustimb6__HH__
#define __s_compute_acoustimb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustimb6) {
    ...
    SC_CTOR(s_compute_acoustimb6):  ACMP_sitodp_U ("ACMP_sitodp_U") {
