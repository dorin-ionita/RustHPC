...
#ifndef __s_compute_acoustincg__HH__
#define __s_compute_acoustincg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(s_compute_acoustincg) {
    ...
    SC_CTOR(s_compute_acoustincg):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
