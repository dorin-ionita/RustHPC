...
set out_width 15
set exp i0*i1
set arg_lists {i0 {8 0 +} i1 {15 1 +} p {15 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {15 1 +} m {15 1 +} i2 {8 1 +} p {15 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 58
set MemName s_compute_acoustiocq
...
# Memory (RAM/ROM)  definition:
set ID 59
set MemName s_compute_acoustipcA
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 64
set AddrRange 10000
...
# Memory (RAM/ROM)  definition:
set ID 60
set MemName s_compute_acoustiqcK
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 64
set AddrRange 10000
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 61 \
			corename s_compute_acoustics_CONTROL_BUS_axilite \
			name s_compute_acoustics_CONTROL_BUS_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler s_compute_acoustics_CONTROL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 8.75 \ 
    name {s_compute_acoustics_result_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler s_compute_acoustics_result_m_axi
}
